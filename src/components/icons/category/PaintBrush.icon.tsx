...
const PaintBrush = (props: ComponentProps<"svg">) => {
  return (
      <svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
          ...
          <path d="M43.9058 45.3906C51.4058 35.2734 70.4683 12.1094 87.8901 12.1094C87.8901 29.5312 64.7261 48.5938 54.6089 56.0938" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M51.9531 35.3916C57.246 38.3787 61.6223 42.755 64.6094 48.0479" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
      </svg>
